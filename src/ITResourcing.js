...
export default function ITResourcing() {
  // State for dynamic resourcing metrics
  ...
  // Fetch dynamic metrics on component mount
  useEffect(() => {
                ...
                <div className="bg-white border border-gray-200 p-6 rounded-lg">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-2xl text-blue-500">{isLoading ? 'Loading...' : metrics.activeResources}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Talent Pool</span>
                      <span className="text-2xl text-green-500">{isLoading ? 'Loading...' : metrics.talentPool}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Client Companies</span>
                      <span className="text-2xl text-purple-500">{isLoading ? 'Loading...' : metrics.clientCompanies}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Avg. Placement Time</span>
                      <span className="text-2xl text-red-500">{isLoading ? 'Loading...' : metrics.avgPlacementTime}</span>
                    </div>
                  </div>
                </div>
