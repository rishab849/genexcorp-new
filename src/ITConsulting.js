        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-3 space-y-4 sm:space-y-6 md:space-y-8 text-gray-700 leading-relaxed">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 sm:p-6 md:p-8 rounded-lg border border-blue-200">
                <div className="flex items-start space-x-3 sm:space-x-4 mb-4 sm:mb-6">
                  <div className="bg-blue-500 p-2 sm:p-3 rounded-lg">
                    <GitBranch className="h-6 sm:h-8 w-6 sm:w-8 text-white" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg sm:text-xl md:text-2xl text-gray-800 mb-3 sm:mb-4">IT Consulting Services</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mt-4 sm:mt-6">
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                    ...
                    <h5 className="text-xs sm:text-sm text-gray-800 mb-1">Spark Development</h5>
                    <p className="text-xs text-gray-600">Big data analytics with Apache Spark</p>
                  </div>
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                    <Layers className="h-5 sm:h-6 w-5 sm:w-6 text-blue-600 mb-2" />
                    <h5 className="text-xs sm:text-sm text-gray-800 mb-1">FullStack Development</h5>
                    <p className="text-xs text-gray-600">End-to-end application solutions</p>
                  </div>
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                    <Bot className="h-5 sm:h-6 w-5 sm:w-6 text-blue-600 mb-2" />
                    <h5 className="text-xs sm:text-sm text-gray-800 mb-1">ChatBot Development</h5>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-violet-50 p-4 sm:p-6 md:p-8 rounded-lg border border-purple-200">
                <div className="flex items-start space-x-3 sm:space-x-4 mb-4 sm:mb-6">
                  <div className="bg-purple-500 p-2 sm:p-3 rounded-lg">
                    <Database className="h-6 sm:h-8 w-6 sm:w-8 text-white" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg sm:text-xl md:text-2xl text-gray-800 mb-3 sm:mb-4">Technology Consulting Arena</h3>
                    <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mt-4 sm:mt-6">
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                    <TrendingUp className="h-5 sm:h-6 w-5 sm:w-6 text-purple-600 mb-2" />
                    <h5 className="text-xs sm:text-sm text-gray-800 mb-1">Tableau</h5>
                    <p className="text-xs text-gray-600">Data visualization and analytics</p>
                  </div>
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                    <Code className="h-5 sm:h-6 w-5 sm:w-6 text-purple-600 mb-2" />
                    <h5 className="text-xs sm:text-sm text-gray-800 mb-1">Hive</h5>
                    <p className="text-xs text-gray-600">Big data warehousing</p>
                  </div>
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                    <Cog className="h-5 sm:h-6 w-5 sm:w-6 text-purple-600 mb-2" />
                    <h5 className="text-xs sm:text-sm text-gray-800 mb-1">Informatica</h5>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-4 sm:p-6 md:p-8 rounded-lg border border-green-200">
                <div className="flex items-start space-x-3 sm:space-x-4 mb-4 sm:mb-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg sm:text-xl md:text-2xl text-gray-800 mb-3 sm:mb-4">Functional Consulting Arena</h3>
                    <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-4 sm:mt-6">
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                    <Factory className="h-5 sm:h-6 w-5 sm:w-6 text-green-600 mb-2" />
                    <h5 className="text-xs sm:text-sm text-gray-800 mb-1">Manufacturing</h5>
                    <p className="text-xs text-gray-600">Industrial operations optimization</p>
                  </div>
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                    <Heart className="h-5 sm:h-6 w-5 sm:w-6 text-green-600 mb-2" />
                    <h5 className="text-xs sm:text-sm text-gray-800 mb-1">Life Science</h5>
                    <p className="text-xs text-gray-600">Healthcare and research solutions</p>
                  </div>
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                    <Landmark className="h-5 sm:h-6 w-5 sm:w-6 text-green-600 mb-2" />
                    <h5 className="text-xs sm:text-sm text-gray-800 mb-1">Banking</h5>
                    <p className="text-xs text-gray-600">Financial services consulting</p>
                  </div>
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                    <Truck className="h-5 sm:h-6 w-5 sm:w-6 text-green-600 mb-2" />
                    <h5 className="text-xs sm:text-sm text-gray-800 mb-1">Logistics</h5>
              ...
              <div className="mt-6 sm:mt-8 md:mt-12 bg-gradient-to-r from-gray-50 to-slate-50 p-4 sm:p-6 md:p-8 rounded-lg border border-gray-200">
                <h4 className="text-base sm:text-lg md:text-xl text-gray-800 mb-3 sm:mb-4">Our Consulting Methodology</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
                  <div className="text-center">
                    ...
                    <h5 className="text-sm sm:text-base text-gray-800 mb-2">Discovery</h5>
                    <p className="text-xs sm:text-sm text-gray-600">Understand business objectives</p>
                  </div>
                  <div className="text-center">
                    ...
                    <h5 className="text-sm sm:text-base text-gray-800 mb-2">Analysis</h5>
                    <p className="text-xs sm:text-sm text-gray-600">Assess systems and processes</p>
                  </div>
                  <div className="text-center">
                    ...
                    <h5 className="text-sm sm:text-base text-gray-800 mb-2">Solution Design</h5>
                    <p className="text-xs sm:text-sm text-gray-600">Craft tailored strategies</p>
                  </div>
                  <div className="text-center">
                    ...
                    <h5 className="text-sm sm:text-base text-gray-800 mb-2">Implementation</h5>
                    <p className="text-xs sm:text-sm text-gray-600">Execute and optimize solutions</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-4 sm:top-8 space-y-4 sm:space-y-6">
                ...
                <div className="bg-white border border-gray-200 p-4 sm:p-6 rounded-lg">
                  <h4 className="text-base sm:text-lg text-gray-800 mb-3 sm:mb-4">Consulting Metrics</h4>
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm text-gray-600">Active Consultants</span>
                      <span className="text-lg sm:text-xl md:text-2xl text-blue-500">{metrics.activeConsultants}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm text-gray-600">Technology Partners</span>
                      <span className="text-lg sm:text-xl md:text-2xl text-green-500">{metrics.technologyPartners}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm text-gray-600">Industry Domains</span>
                      <span className="text-lg sm:text-xl md:text-2xl text-purple-500">{metrics.industryDomains}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm text-gray-600">Consulting Projects</span>
                      <span className="text-lg sm:text-xl md:text-2xl text-red-500">{metrics.consultingProjects}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-red-50 to-orange-50 p-4 sm:p-6 rounded-lg">
                  <h4 className="text-base sm:text-lg text-gray-800 mb-3 sm:mb-4">Service Areas</h4>
                  <div className="flex flex-wrap gap-2 sm:gap-3">
                    <span className="bg-blue-100 text-blue-700 px-2 sm:px-3 py-1 rounded-full text-xs">DevOps</span>
                    <span className="bg-orange-100 text-orange-700 px-2 sm:px-3 py-1 rounded-full text-xs">Big Data</span>
                    <span className="bg-green-100 text-green-700 px-2 sm:px-3 py-1 rounded-full text-xs">FullStack</span>
                    <span className="bg-purple-100 text-purple-700 px-2 sm:px-3 py-1 rounded-full text-xs">Web Dev</span>
                    <span className="bg-teal-100 text-teal-700 px-2 sm:px-3 py-1 rounded-full text-xs">ServiceNow</span>
                    <span className="bg-yellow-100 text-yellow-700 px-2 sm:px-3 py-1 rounded-full text-xs">ChatBots</span>
                    <span className="bg-gray-100 text-gray-700 px-2 sm:px-3 py-1 rounded-full text-xs">AWS</span>
                  </div>
                </div>

                {/* Expertise Levels */}
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 sm:p-6 rounded-lg">
                  <h4 className="text-base sm:text-lg text-gray-800 mb-3 sm:mb-4">Expertise Levels</h4>
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm text-gray-700">Senior Consultants</span>
                      <span className="text-xs sm:text-sm text-blue-600">80%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2 sm:h-3">
                      <div className="bg-blue-500 h-2 sm:h-3 rounded-full" style={{ width: '80%' }}></div>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm text-gray-700">Mid-Level Consultants</span>
                      <span className="text-xs sm:text-sm text-green-600">25%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2 sm:h-3">
                      <div className="bg-green-500 h-2 sm:h-3 rounded-full" style={{ width: '25%' }}></div>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm text-gray-700">Junior Consultants</span>
                      <span className="text-xs sm:text-sm text-orange-600">5%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2 sm:h-3">
                      <div className="bg-orange-500 h-2 sm:h-3 rounded-full" style={{ width: '5%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
