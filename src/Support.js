    ...
    <main className="flex flex-1">
      ...
      <div className="flex-1 px-4 sm:px-8 py-16">
        <div className="max-w-7xl mx-auto">
          {/* Blue Quote Section */}
          <div className="border-l-4 border-blue-500 pl-4 sm:pl-8 mb-12">
            <h1 className="text-3xl sm:text-5xl text-gray-800 mb-6">
              <span className="text-red-500">Support</span>
            </h1>
            <h2 className="text-xl sm:text-3xl text-blue-600 mb-4">
              Learn to get in touch with the silence within yourself, and know that everything in life has purpose. There are no mistakes, no coincidences, all events are blessings given to us to learn from.
            </h2>
          </div>

          <div className="grid lg:grid-cols-4 gap-6 sm:gap-12">
            {/* Left Content */}
            <div className="lg:col-span-3 space-y-8 text-gray-700 leading-relaxed">
              {/* Contact Form Section */}
              <div className="space-y-6">
                <h3 className="text-xl sm:text-2xl text-gray-800 mb-8">Get in Touch</h3>
                <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-8">
                  ...
                  <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 border ${errors.name ? "border-red-500" : "border-gray-300"} rounded-md focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500`}
                          value={formData.name}
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 border ${errors.designation ? "border-red-500" : "border-gray-300"} rounded-md focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500`}
                    ...
                    <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 border ${errors.mobile ? "border-red-500" : "border-gray-300"} rounded-md focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500`}
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 border ${errors.email ? "border-red-500" : "border-gray-300"} rounded-md focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500`}
                    ...
                    <div className="flex justify-start">
                      <button type="submit" className="bg-cyan-500 hover:bg-cyan-600 text-white px-6 sm:px-8 py-2 rounded-md flex items-center space-x-2">
              ...
              <div className="mt-12">
                <h3 className="text-xl sm:text-2xl text-gray-800 mb-8">Technology Consulting Arena</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-12">
                  <div className="bg-white border border-gray-200 rounded-lg p-6 sm:p-8 hover:shadow-lg transition-shadow text-center">
              ...
              <div className="mt-12">
                <h3 className="text-xl sm:text-2xl text-gray-800 mb-8">Functional Consulting Arena</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
                  <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow text-center">
                    <ShoppingCart className="h-8 sm:h-10 w-8 sm:w-10 text-green-600 mx-auto mb-3" />
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow text-center">
                    <Factory className="h-8 sm:h-10 w-8 sm:w-10 text-blue-600 mx-auto mb-3" />
                  ...
                  <div className="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow text-center">
                    <Building2 className="h-8 sm:h-10 w-8 sm:w-10 text-red-600 mx-auto mb-3" />
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow text-center">
                    <Heart className="h-8 sm:h-10 w-8 sm:w-10 text-purple-600 mx-auto mb-3" />
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow text-center">
                    <Shield className="h-8 sm:h-10 w-8 sm:w-10 text-orange-600 mx-auto mb-3" />
                  ...
                  <div className="bg-gradient-to-br from-teal-50 to-teal-100 border border-teal-200 rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow text-center">
                    <Landmark className="h-8 sm:h-10 w-8 sm:w-10 text-teal-600 mx-auto mb-3" />
                  ...
                  <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-200 rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow text-center">
                    <Truck className="h-8 sm:h-10 w-8 sm:w-10 text-yellow-600 mx-auto mb-3" />
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow text-center">
                    <Package className="h-8 sm:h-10 w-8 sm:w-10 text-gray-600 mx-auto mb-3" />
              ...
              {/* Support Commitment */}
              <div className="mt-12 bg-gradient-to-r from-blue-50 to-purple-50 p-4 sm:p-8 rounded-lg">
                <h4 className="text-lg sm:text-xl text-gray-800 mb-3">Our Support Commitment</h4>
